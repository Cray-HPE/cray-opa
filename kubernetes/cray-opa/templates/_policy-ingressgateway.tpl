...
sub_match = {
    ...
    "spiffe://{{ .Values.jwtValidation.spire.trustDomain }}/uan/workload/cfs-state-reporter": allowed_methods["system-compute"],
    ...
    "spiffe://{{ .Values.jwtValidation.spire.trustDomain }}/uan/workload/cpsmount": allowed_methods["system-compute"],
    "spiffe://{{ .Values.jwtValidation.spire.trustDomain }}/uan/workload/cpsmount_helper": allowed_methods["system-compute"],
    "spiffe://{{ .Values.jwtValidation.spire.trustDomain }}/uan/workload/dvs-hmi": allowed_methods["system-compute"],
    "spiffe://{{ .Values.jwtValidation.spire.trustDomain }}/uan/workload/dvs-map": allowed_methods["system-compute"],
    "spiffe://{{ .Values.jwtValidation.spire.trustDomain }}/uan/workload/heartbeat": allowed_methods["system-compute"],
    "spiffe://{{ .Values.jwtValidation.spire.trustDomain }}/uan/workload/orca": allowed_methods["system-compute"],
    "spiffe://{{ .Values.jwtValidation.spire.trustDomain }}/uan/workload/wlm": allowed_methods["wlm"],
}
{{- end }}
{{ end }}
